...
alter table legal_texts
  ...
  'POLÍTICA DE TRATAMIENTO DE DATOS PERSONALES - MÁS BARATAS DROGUERÍAS

Más Baratas Droguerías, en calidad de responsable del tratamiento de datos personales, informa lo siguiente en cumplimiento de la Ley 1581 de 2012, el Decreto 1377 de 2013 y demás normas que los reglamenten o sustituyan.
...
4. Los datos no se comparten con terceros distintos a los necesarios para el envío del documento firmado (el firmante y Más Baratas Droguerías), salvo requerimiento de autoridad competente.
...
-- Por si ya habías corrido este script antes: la columna data_policy_full_text
-- solo toma su valor por defecto la primera vez que se crea, así que la
-- actualizamos explícitamente para que el nombre correcto de la empresa
-- quede reflejado aunque relances este script.
update legal_texts set data_policy_full_text =
  'POLÍTICA DE TRATAMIENTO DE DATOS PERSONALES - MÁS BARATAS DROGUERÍAS
